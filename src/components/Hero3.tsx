...
<div className="min-h-screen flex justify-center items-center">
      <div className="w-[70%] h-full min-h-[80vh] bg-[#121212] rounded-2xl p-10 text-center flex flex-col justify-center">
        <h1 className="text-white text-5xl font-bold mb-4">
          Chat de la IA
        </h1>
        <p className="text-gray-400 text-lg">
          Aca iria el tipico chat que refleja los mensajes del usuario y de la IA.
        </p>
      </div>
    </div>
